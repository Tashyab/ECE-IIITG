// ======================================================================
// display_voltage.v generated from TopDesign.cysch
// 04/16/2024 at 01:46
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("3489b9e7-0b40-4a56-b291-a860596685dc/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("65651b17-e3d7-43e8-9484-d779e00dd02c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LED_blinking_net;
	wire [0:0] tmpFB_0__LED_blinking_net;
	wire [0:0] tmpIO_0__LED_blinking_net;
	wire [0:0] tmpINTERRUPT_0__LED_blinking_net;
	electrical [0:0] tmpSIOVREF__LED_blinking_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_blinking
		 (.oe(tmpOE__LED_blinking_net),
		  .y({Net_146}),
		  .fb({tmpFB_0__LED_blinking_net[0:0]}),
		  .io({tmpIO_0__LED_blinking_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_blinking_net),
		  .interrupt({tmpINTERRUPT_0__LED_blinking_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_blinking_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
