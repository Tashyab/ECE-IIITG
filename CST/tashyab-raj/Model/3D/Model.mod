...
'# frequency = GHz
'# time = ns
'# frequency range: fmin = 5 fmax = 10
'# created = '[VERSION]2019.0|28.0.2|20180920[/VERSION]


'@ use template: Waveguide Coupler & Divider_6.cfg
...
'[VERSION]2019.0|28.0.2|20180920[/VERSION]
Pick.PickEdgeFromId "component1:solid1", "15", "11" 
...
With Dimension
    ...
    .SetDistance "8.058110"
    .SetViewVector "-0.469828", "-0.342121", "-0.813766"
...
'[VERSION]2019.0|28.0.2|20180920[/VERSION]
Pick.PickEdgeFromId "component1:solid1", "31", "24" 
...
'[VERSION]2019.0|28.0.2|20180920[/VERSION]
Pick.PickEdgeFromId "component1:solid1", "24", "10" 
...
With Dimension
    ...
    .SetID "2"
    .SetOrientation "Smart Mode"
    .SetDistance "-14.229114"
    .SetViewVector "-0.469834", "-0.342086", "-0.813777"
    .SetConnectedElement1 "component1:solid1"
    .SetConnectedElement2 "component1:solid1"
    .Create
End With
...
'[VERSION]2019.0|28.0.2|20180920[/VERSION]
Pick.PickEdgeFromId "component1:solid1", "14", "10" 
