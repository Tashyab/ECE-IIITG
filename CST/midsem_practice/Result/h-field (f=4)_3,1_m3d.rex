...
<MetaResultFile creator="Solver HFTD - Field 3DFD Monitor" version="20170330">
  ...
  <SimulationProperties dB_Amplitude="20" encoded_unit="&amp;U:A^1.:m^-1" fieldname="&lt;name missing&gt;" fieldtype="H-Field" frequency="4"/>
  <MetaGeometryFile filename="model.gex" lod="1"/>
  <ResultGroups num_steps="1">
    <SharedDataWith treepath="2D/3D Results\Surface Current\surface current (f=4) [3]" rexname="h-field (f=4)_3,1_m3d_sct.rex"/>
    <Frame index="0">
      <FieldResultFile filename="h-field (f=4)_3,1.m3d" type="m3d"/>
    </Frame>
  </ResultGroups>
