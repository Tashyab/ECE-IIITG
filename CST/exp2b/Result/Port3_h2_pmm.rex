...
<MetaResultFile creator="FE Port mode solver" version="20170330">
  ...
  <SimulationProperties dB_Amplitude="20" encoded_unit="&amp;U:A^1.:m^-1" fieldname="Port3 h2" fieldtype="H-Field" frequency="0"/>
  <MetaGeometryFile filename="" lod="1"/>
  <ResultGroups num_steps="1">
    <Frame index="0" characteristic="12.5">
      <FieldResultFile filename="Port3_h2[12.5].prt" meshname="Port3_h2_pmm.slim" type="prt"/>
    </Frame>
  </ResultGroups>
  ...
  <PlotSettings Clipping="Always on" Plot="1" ignore_symmetry="0" deformation="0">
    <Plane normal="-0 1 0" distance="35"/>
  </PlotSettings>
  <Source type="SOLVER"/>
  <Units>
