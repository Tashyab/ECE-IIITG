...
<MetaResultFile creator="FE Port mode solver" version="20170330">
  ...
  <SimulationProperties dB_Amplitude="20" encoded_unit="&amp;U:A^1.:m^-1" fieldname="Port3 h3" fieldtype="H-Field" frequency="0"/>
  <MetaGeometryFile filename="" lod="1"/>
  <ResultGroups num_steps="1">
    <Frame index="0" characteristic="12.5">
      <FieldResultFile filename="Port3_h3[12.5].prt" meshname="Port3_h3_pmm.slim" type="prt"/>
    </Frame>
  </ResultGroups>
