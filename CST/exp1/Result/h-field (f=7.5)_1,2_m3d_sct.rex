...
<MetaResultFile creator="Solver HFTD - Field 3DFD Monitor" version="20170330">
  ...
  <SimulationProperties dB_Amplitude="20" encoded_unit="&amp;U:A^1.:m^-1" fieldname="&lt;name missing&gt;" fieldtype="Surface current" frequency="7.5"/>
  <MetaGeometryFile filename="model.gex" lod="1"/>
  <ResultGroups num_steps="1">
    <SharedDataWith treepath="2D/3D Results\H-Field\h-field (f=7.5) [1(2)]" rexname="h-field (f=7.5)_1,2_m3d.rex"/>
    <Frame index="0">
