...
<MetaResultFile creator="Solver HFTD - Field 3DFD Monitor" version="20170330">
  ...
  <ResultGroups num_steps="1">
    <SharedDataWith treepath="2D/3D Results\Surface Current\surface current (f=7.5) [2(2)]" rexname="h-field (f=7.5)_2,2_m3d_sct.rex"/>
    <Frame index="0">
      <FieldResultFile filename="h-field (f=7.5)_2,2.m3d" type="m3d"/>
    </Frame>
  </ResultGroups>
