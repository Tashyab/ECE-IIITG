...
<MetaResultFile creator="Solver HFTD - Field 3DFD Monitor" version="20170330">
  ...
  <ResultGroups num_steps="1">
    <SharedDataWith treepath="2D/3D Results\H-Field\h-field (f=10) [2(2)]" rexname="h-field (f=10)_2,2_m3d.rex"/>
    <Frame index="0">
      <FieldResultFile filename="h-field (f=10)_2,2.m3d" type="m3d"/>
    </Frame>
  </ResultGroups>
